...
// class FinanceMiddleBar extends StatefulWidget {
//   final List<String> texts;
...
//
//   @override
//   State<FinanceMiddleBar> createState() => _FinanceMiddleBarState();
// }
//
// class _FinanceMiddleBarState extends State<FinanceMiddleBar> {
//   int selectedIndex1 = 0;
//
//   @override
//   Widget build(BuildContext context) {
...
//           setState(() {
//             selectedIndex1 = index;
//             DrAidCubit.get(context).changeFinanceIndex(index);
//
//
//           });
//         },
...
//         },
//         child: Container(
//           width: MediaQuery.of(context).size.width > 600 ? 246 : 200,
//           height: 50,
//           decoration: BoxDecoration(
//             color: selectedIndex1 == index ? buttonColor : Colors.white,
//             borderRadius: BorderRadius.circular(30),
...
//           children: [
//             Container(
//               width: MediaQuery.of(context).size.width * (MediaQuery.of(context).size.width > 600 ? 0.65 : 0.85),
//               height: 50,
//               decoration: BoxDecoration(
//                 color: Colors.white,
//                 borderRadius: BorderRadius.circular(30),
          ...
          return InkWell(
            ...
            return InkWell(
              ...
              child: Container(
                ...
                height: 50,
                decoration: BoxDecoration(
                  color: selectedIndex1 == index ? Colors.orangeAccent : Colors.white,
                  borderRadius: BorderRadius.circular(30),
                ),
                child: Padding(
                  padding: const EdgeInsets.all(10),
